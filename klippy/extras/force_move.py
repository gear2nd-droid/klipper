...
class ForceMove:
    ...
    def cmd_SET_KINEMATIC_POSITION(self, gcmd):
        ...
        logging.info("SET_KINEMATIC_POSITION pos=%.3f,%.3f,%.3f,%.3f,%.3f,%.3f clear=%s",
                     x, y, z, a, b, c, clear_axes)
        toolhead.set_position([x, y, z, a, b, c, curpos[6]], homing_axes="xyzabc")
